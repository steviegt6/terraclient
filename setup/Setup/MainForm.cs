...
namespace Terraria.ModLoader.Setup
{
	public partial class MainForm : Form, ITaskInterface
	{
		...
		public MainForm()
		{
			...
			taskButtons[buttonDiffModLoader] = () => new DiffTask(this, "src/Terraria", "src/Terraclient", "patches/Terraclient", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
			taskButtons[buttonPatchModLoader] = () => new PatchTask(this, "src/Terraria", "src/Terraclient", "patches/Terraclient", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
