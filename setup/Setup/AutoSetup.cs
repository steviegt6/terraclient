...
namespace Terraria.ModLoader.Setup
{
	class AutoSetup : ITaskInterface
	{
		...
		public void DoAuto() {
			...
			Func<SetupOperation> buttonPatchModLoader = () => new PatchTask(this, "src/Terraria", "src/Terraclient", "patches/Terraclient", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
